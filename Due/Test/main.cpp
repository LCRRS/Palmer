...
void warmup()
{
    ...
    myPID_yaw.SetSampleTime(25); //Time to pass between the values of PID are recomputed (in milliseconds)
    myPID_pitch.SetSampleTime(25);
    myPID_roll.SetSampleTime(25);
